            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-12">
                    ...
                    <article class="post single-post-inner">
                        ...
                        <div class="post-inner-featured-content">
                            <img alt="" src="{{ asset('blood_donation/images/blog_3.jpg') }}">
                        </div>
                        ...
                        <div class="single-post-inner-title">
                            ...
                            <p class="single-post-meta"><i class="fa fa-user"></i>&nbsp; Deborah Beck &nbsp; &nbsp; <i
                                    class="fa fa-share"></i>&nbsp; Environment, Pet & Education</p>
                        </div>

                        <div class="single-post-inner-content">
                            <p>
                                The theme of this year’s World Blood Donor Day is “Blood connects us all”. It focuses on
                                thanking blood donors and highlights the dimension of “sharing” and “connection” between
                                blood donors and patients. In addition, we have adopted the slogan “Share life, give blood”,
                                to draw attention to the roles that voluntary donation systems play in encouraging people to
                                care for one another and promote community cohesion.
                            </p>
                            <p>
                    ...
                    <div class="comments-area" id="comments">
                        ...
                        <ol class="commentslist">
                            ...
                            <li>
                                <article class="clearfix">
                                    ...
                                    <figure class="comment-avatar">
                                        <a href="#">
                                            <img src="{{ asset('blood_donation/images/user_2.jpg') }}" alt="Avatar">
                                        </a>
                                    </figure>
                                    ...
                                    <li>
                                        <article class="clearfix">
                                            <header>
                                                ...
                                                <p><span>on jan 19th, 2013 at 3:05 Pm - </span><a href="#">Reply</a>
                                                </p>
                                            </header>

                                            <figure class="comment-avatar">
                                                <a href="#">
                                                    <img src="{{ asset('blood_donation/images/user_3.jpg') }}" alt="Avatar">
                                                </a>
                                            </figure>
                            ...
                            <li>
                                <article class="clearfix">
                                    ...
                                    <figure class="comment-avatar">
                                        <a href="#">
                                            <img src="{{ asset('blood_donation/images/user_4.jpg') }}" alt="Avatar">
                                        </a>
                                    </figure>
                        ...
                        <div class="comments-nav-section clearfix">
                            ...
                            <a href="#" class="btn btn-primary fr">Newer Comments <i
                                    class="fa fa-angle-double-right"></i></a>
                            <a href="#" class="btn btn-primary"><i class="fa fa-angle-double-left"></i> Older
                                Comments</a>
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="widget site-sidebar">
                        ...
                        <form action="https://templates.bwlthemes.com/blood_donation/index.html" id="search-form"
