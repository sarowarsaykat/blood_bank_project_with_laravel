                ...
                <div class="col-md-8 col-sm-12">
                    ...
                    <article class="post single-post">
                        ...
                        <div class="single-post-content">
                            ...
                            <a title="" href="#">
                                <img alt="" src="{{ asset('blood_donation/images/blog_1.jpg') }}" />
                            </a>
                        ...
                        <div class="single-post-title">
                            ...
                            <p>
                                We have adopted the slogan “Share life, give blood”, to draw attention to the roles that
                    ...
                    <article class="post single-post">
                        ...
                        <div class="single-post-content">
                            ...
                            <a title="" href="#">
                                <img alt="" src="{{ asset('blood_donation/images/blog_2.jpg') }}" />
                            </a>
